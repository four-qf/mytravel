...
<head>
	...
	<script language="javascript" src="${pageContext.request.contextPath}/roleScript/jquery_treeview/jquery.treeview.js"></script>
	<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/style/blue/file.css" />
	<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/roleScript/jquery_treeview/jquery.treeview.css" />
...
<div id=MainArea>
    ...
    <s:form action="role_setPrivilege">
        ...
        <div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="${pageContext.request.contextPath}/style/blue/images/item_point.gif" /> 正在为【${model.name}】配置权限 </div> 
        </div>
