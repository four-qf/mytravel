        ...
        this.each(function (i, cont) {
            ...
            var newList = {
                ...
                grabItem: function (e) {
                    ...
                    if (opts.placeHolderTemplateFunc) {
                        opts.placeHolderTemplate = opts.placeHolderTemplateFunc(elm);
                    }
                ...
                dropItem: function (e) {
                    ...
                    if (opts.dropEnd && tempXY) {                        
                        opts.dropEnd.apply({ sourceJQueryEle: list.draggedItem,  offsetX: e.pageX - tempXY[0], offsetY: e.pageY - tempXY[1] });
                    }
